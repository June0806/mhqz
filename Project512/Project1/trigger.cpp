...
BOOL cTaskHuoDong::Processmp(int stage)
{
	...
	case 13:
		...
		{
			m_NowNpc = g_pMainState->m_pNowSelect;
			m_NowNpc->Talk("要领取任务吗?", this, 14, "是", "否");
		}
		break;
	case 14:
	{
	...
	case 15:
		
		{
			...
			cJiangLi jiangli;
			jiangli.SetBaoShi(25);//宝石
			jiangli.Add(3, 27, 20, 3); //66
			jiangli.Add(33, 27, 20);//彩果
			jiangli.AddLShouJue(10);//低兽决
			jiangli.AddHShouJue(5);//低兽决
			jiangli.Add(38, 27, 20, 4);//强化石
			jiangli.AutoGetJiangLi();
			m_HuanShu += 1;
			if (m_pTask)
